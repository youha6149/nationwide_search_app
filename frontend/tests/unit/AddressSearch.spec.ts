...
describe("AddressSearch.vue", () => {
    ...
    beforeEach(() => {
        mockAlert = vi.spyOn(window, "alert").mockImplementation(() => { }) as Mock<(message?: any) => void>;
        mockPush.mockClear();
        mockAlert.mockClear();

        wrapper = shallowMount(AddressSearch) as VueWrapper & { vm: AddressSearchProps };
    });
    ...
    describe("Component Rendering", () => {
        it("renders the component correctly", () => {
            ...
            expect(wrapper.find("h1").text()).toBe("Find the best location for your project");
